...
export class MpEntityType {
    ...
    static cogInventory = 'CogInventory';
    static cogInstrument = 'CogInstrument';
    static cogEcmspeResult = 'CogEcmspeResult';
    static cogEcpeResult = 'CogEcpeResult';
    static cogEsalbResult = 'CogEsalbResult';
    static cogEtmpreResult = 'CogEtmpreResult';
    static cogResponse = 'CogResponse';
    static roadRunner = 'RoadRunner';
}
...
export class MpCogInstrumentType {
    static ecpe = 'ECPE';
    static ecmspe = 'ECMSPE';
    static esalb = 'ESALB';
    static etmpre = 'ETMPRE';
}

export class MpCogETMPREInvType {
    static spont = 'Spontaneous';
    static norm = 'Normative';
    static meth = 'Methodical';
    static conc = 'Conceptual';
}

export class MpCogECPEInvType {
    static blind = 'Blind';
    static r = 'R';
    static o = 'O';
    static e = 'E';
...
export class MpCogESALBInvType {
    static lais = 'Laissez Faire';
    static man = 'Management';
    static cont = 'Contingent';
    static ideal = 'Idealized';
    static inspir = 'Inspirational';
    static intellect = 'Intellectual Stimulation';
    static indiv = 'Individual';
}

export class MpCogECMSPEInvType {
    static compete = 'Compete';
    static collab = 'Collaborate';
    static accom = 'Accommodate';
    static avoid = 'Avoid';
    static compro = 'Compromise';
}